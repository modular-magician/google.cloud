...
def self_link(module):
    return "https://www.googleapis.com/v1beta4/projects/{project}/instances/{name}".format(**module.params)


def collection(module):
    return "https://www.googleapis.com/v1beta4/projects/{project}/instances".format(**module.params)
