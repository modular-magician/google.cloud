...
def self_link(module):
    return "https://www.googleapis.com/projects/{project}/instances/{name}".format(**module.params)


def collection(module):
    return "https://www.googleapis.com/projects/{project}/instances".format(**module.params)
