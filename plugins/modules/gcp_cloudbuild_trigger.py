                        ...
                        options=dict(
                            ...
                            objects=dict(
                                ...
                                options=dict(
                                    ...
                                    timing=dict(type='dict', options=dict(start_time=dict(type='str'), end_time=dict(type='str'))),
                                ),
                            ),
                        ),
                    ),
...
class TriggerObjects(object):
    ...
    def to_request(self):
        return remove_nones_from_dict(
            {
                u'location': self.request.get('location'),
                u'paths': self.request.get('paths'),
                u'timing': TriggerTiming(self.request.get('timing', {}), self.module).to_request(),
            }
        )
    ...
    def from_response(self):
        return remove_nones_from_dict(
            {
                u'location': self.request.get(u'location'),
                u'paths': self.request.get(u'paths'),
                u'timing': TriggerTiming(self.request.get(u'timing', {}), self.module).from_response(),
            }
        )
