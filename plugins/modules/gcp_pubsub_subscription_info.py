  ...
  contains:
    ...
    retryPolicy:
      ...
      - Retry Policy is implemented on a best effort basis. At times, the delay between
        consecutive deliveries may not match the configuration. That is, delay can
        be more or less than configured backoff.
      returned: success
      type: complex
      contains:
        maximumBackoff:
          description:
          - Specifies the maximum delay between consecutive deliveries of a given
        ...
        minimumBackoff:
          description:
          - Specifies the minimum delay between consecutive deliveries of a given
            message.
