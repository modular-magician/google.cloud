...
resources:
  ...
  contains:
    ...
    extraStatements:
      ...
      - Once a database is created, changes to this list cannot be used to migrate
        the schema in the existing database. We recommend users to rely on schema
        management tools instead of using this option.
      returned: success
      type: list
    instance:
      description:
